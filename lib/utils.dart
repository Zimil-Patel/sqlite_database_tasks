...
final List<Map<String, dynamic>> expenseCategories = [
  {'name': 'Food & Dining', 'icon': Icons.restaurant, 'color': Colors.orange[100]},
  {'name': 'Transport', 'icon': Icons.directions_car, 'color': Colors.blue[100]},
  {'name': 'Groceries', 'icon': Icons.local_grocery_store, 'color': Colors.green[100]},
  {'name': 'Shopping', 'icon': Icons.shopping_bag, 'color': Colors.pink[100]},
  {'name': 'Bills & Utilities', 'icon': Icons.lightbulb, 'color': Colors.yellow[100]},
  {'name': 'Health & Fitness', 'icon': Icons.fitness_center, 'color': Colors.red[100]},
  ...
  {'name': 'Loans', 'icon': Icons.attach_money, 'color': Colors.deepOrange[100]},
  {'name': 'Investments', 'icon': Icons.trending_up, 'color': Colors.lightGreen[100]},
